...
import time
import numpy as np
from lib_unprompted.gpen.face_detect.retinaface_detection import RetinaFaceDetection
from lib_unprompted.gpen.face_parse.face_parsing import FaceParse
from lib_unprompted.gpen.face_model.face_gan import FaceGAN
from lib_unprompted.gpen.sr_model.real_esrnet import RealESRNet
from lib_unprompted.gpen.align_faces import warp_and_crop_face, get_reference_facial_points
...
class FaceEnhancement(object):
	def __init__(self, args, base_dir='./', in_size=512, out_size=None, model=None, use_sr=True, device='cuda',interp=3):
		...
		outer_padding = (0, 0)
		self.reference_5pts = get_reference_facial_points((self.in_size, self.in_size), inner_padding_factor, outer_padding, default_square)
